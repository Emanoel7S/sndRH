...
{{--        </ol>--}}
        ...
        <div class="card mb-4">
			...
			<form role="form" action="{{ url('cadastros/motoristas/editar')}}" class="form" method="post">
			 ...
			 <input type="hidden" name="id" id="id" value="{{ $r->id}}" />
				 ...
				 <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <input type="text" name="cpf"  class="form-control"  required value="{{$r->cpf}}">
                        </div>
                    ...
                    <div class="form-group row">
                            ...
                            <div class="col-sm-11">
                              <input type="email" name="email"  class="form-control"  required value="{{$r->email}}">
                            </div>
                    </div>
                ...
                <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                          <input type="text" name="tipo_cnh"  class="form-control"  value="{{$r->tipo_cnh}}">
                        </div>

                         <label for="cnh" class="col-sm-1 col-form-label">CNH</label>
                        <div class="col-sm-4">
                          <input type="text" name="cnh"  class="form-control"  value="{{$r->cnh}}">
                        </div>
                          <label for="validade_cnh" class="col-sm-1 col-form-label">Validade</label>
                        <div class="col-sm-3">
                          <input type="date" name="validade_cnh"   class="form-control"  value="{{$r->validade_cnh}}">
